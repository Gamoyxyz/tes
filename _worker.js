...
// 生成配置文件的 CF 优选 IP
const bestCFIP = "104.22.5.240"

// 用于 CF 网站的代理 IP
const proxyIPs = ["54.251.92.52", "54.169.229.188", "52.74.101.26", "18.141.204.88", "13.229.159.215", "13.228.155.72", "13.228.142.218"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
